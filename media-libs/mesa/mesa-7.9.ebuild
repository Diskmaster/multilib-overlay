...
inherit base autotools multilib flag-o-matic toolchain-funcs ${GIT_ECLASS} multilib-native
...
DEPEND="${RDEPEND}
	...
	>=x11-proto/glproto-1.4.11[lib32?]
	x11-proto/inputproto[lib32?]
	>=x11-proto/xextproto-7.0.99.1[lib32?]
