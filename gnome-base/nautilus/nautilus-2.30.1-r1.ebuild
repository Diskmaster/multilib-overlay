...
# $Header: /var/cvsroot/gentoo-x86/gnome-base/nautilus/nautilus-2.30.1-r1.ebuild,v 1.8 2010/10/14 21:42:25 maekke Exp $
...
RDEPEND=">=dev-libs/glib-2.24.0[lib32?]
	>=gnome-base/gnome-desktop-2.29.91[lib32?]
