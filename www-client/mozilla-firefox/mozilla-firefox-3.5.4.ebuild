...
# $Header: /var/www/viewcvs.gentoo.org/raw_cvs/gentoo-x86/www-client/mozilla-firefox/mozilla-firefox-3.5.4.ebuild,v 1.2 2009/10/29 13:26:12 anarchy Exp $
EAPI="2"
WANT_AUTOCONF="2.1"

inherit flag-o-matic toolchain-funcs eutils mozconfig-3 makeedit multilib pax-utils fdo-mime autotools mozextension multilib-native
...
RDEPEND="
	...
	>=net-libs/xulrunner-${XUL_PV}[java=,sqlite=,lib32?]
