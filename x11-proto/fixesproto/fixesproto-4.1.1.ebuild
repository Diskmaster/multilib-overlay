...
# $Header: /var/cvsroot/gentoo-x86/x11-proto/fixesproto/fixesproto-4.1.1.ebuild,v 1.10 2010/08/02 18:09:40 armin76 Exp $
...
RDEPEND=">=x11-proto/xextproto-7.0.99.1[lib32?]"
DEPEND="${RDEPEND}"
